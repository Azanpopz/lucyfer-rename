...
-> /tmute @𝗎𝗌𝖾𝗋𝗇𝖺𝗆𝖾 𝟤𝗁
"""
    CAPTION_TEXT = """⚠️  കോപ്പി റൈറ്റ് വരുന്നത് കൊണ്ട് ഇവിടെ വരുന്ന ഫയലുകൾ എല്ലാം 30 സെക്കന്റിനുള്ളിൽ കൊണ്ട് ഇവിടെ നിന്നും ഓട്ടോമാറ്റിക്കായി ഡിലേറ്റാവും...!!!

ഇവിടെ നിന്നും വേറെ എവിടേലും മാറ്റിയതിന് ശേഷം ഡൗൺലോഡ് ചെയ്യുക...!!!

FILES FORWARD TO YOUR SAVED MESSAGES

All files here Gets Deleted With in 30 seconds
𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘 ➧ 𝙐𝙁𝙎 𝘽𝙤𝙩𝙯
━═━═━═━═━═━═━═━═
⟱⟱⟱⟱⟱⟱⟱ 𝕁𝕠𝕚𝕟 ⟱⟱⟱⟱⟱⟱⟱
━═━ @nasrani_update ━═━"""
