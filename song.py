...
@Client.on_message(filters.private & ~filters.bot & ~filters.command("helps") & ~filters.command("starts") & ~filters.command("s"))
...
@Client.on_message(filters.command("sng") & ~filters.edited & filters.group)
async def song(client, message):
    cap = "@JEBotZ"
